...
#define BLOCK_SIZE_SIMILARITY 256 // chosen for 100% occupancy
#define BLOCK_SIZE_RECOMMENDATION 1024 // chosen for 100% occupancy
#define BLOCK_SIZE_DENORMALIZATION 1024
#define TILE_SIZE_SIMILARITY 1024 // assumption max TILE_SIZE ratings per row for SIMILARITY
#define TILE_SIZE_RECOMMENDATION 4096 // assumption max TILE_SIZE ratings per row for RECOMMENDATIONS
